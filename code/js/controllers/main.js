...
(function() {
  var Machine_VM, Main_Controller_VM, Square_VM, Templates,
  ...
  Machine_VM = (function() {
    function Machine_VM(inits) {
      var _this = this;

      this.on = ko.observable(false);
      this.rotate_pos = ko.observable(true);
      this.effect = ko.computed(function() {
        var animate;
        ...
        if (!_this.on()) {
          ...
          return animate = {
            css: {
              '-webkit-transform': _this.rotate_pos() ? 'rotate(5deg)' : 'rotate(-5deg)'
            },
            parameters: {
              duration: '300ms',
              timingfunction: 'ease-out',
              callback: function() {
                return _this.rotate_pos(!_this.rotate_pos());
              }
            }
          };
        }
  ...
  Main_Controller_VM = (function() {
    function Main_Controller_VM(inits) {
      ...
      this.Tap_Dryer = __bind(this.Tap_Dryer, this);
      ...
      this.washer = new Machine_VM();
      this.dryer = new Machine_VM();
    }
    ...
    Main_Controller_VM.prototype.Tap_Dryer = function(d, e) {
      return this.dryer.on(!this.dryer.on());
    };
